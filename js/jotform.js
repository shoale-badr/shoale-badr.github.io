  ...
  */
  handleSignSignatureInputs: function() {
    ...
    errored: function (input, message) {
        ...
        var error_message_wrapper = new Element('div', { className: 'form-error-message', role: 'alert' });

        if (input.style.width) {
            error_message_wrapper.style.width = input.style.width;
        }
        ...
        insertEl.insert(
            error_message_wrapper
                ...
                .insert(
                    new Element('div', { className: 'form-error-arrow' })
                        .insert(new Element('div', { className: 'form-error-arrow-inner' }))
                )
        );
